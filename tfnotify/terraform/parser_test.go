...
data.terraform_remote_state.microservices_platform_development: Refreshing state...
google_project.my_project: Refreshing state... ()
aws_iam_policy.datadog_aws_integration: Refreshing state... ()
aws_iam_user.microservices_terraform: Refreshing state... ()
...
google_project.microservice: Refreshing state... ()
pagerduty_team.microservice: Refreshing state... ()
...
google_project_services.microservice: Refreshing state... ()
google_project_iam_member.microservice[1]: Refreshing state... ()
google_project_iam_member.microservice[2]: Refreshing state... ()
google_project_iam_member.microservice[0]: Refreshing state... ()
google_project_iam_member.microservice_platform[1]: Refreshing state... ()
google_project_iam_member.microservice_platform[2]: Refreshing state... ()
google_project_iam_member.microservice_platform[0]: Refreshing state... ()
pagerduty_team_membership.microservice[2]: Refreshing state... ()
pagerduty_schedule.secondary: Refreshing state... ()
pagerduty_schedule.primary: Refreshing state... ()
pagerduty_team_membership.microservice[0]: Refreshing state... ()
pagerduty_team_membership.microservice[1]: Refreshing state... ()
pagerduty_escalation_policy.microservice: Refreshing state... ()
pagerduty_service.microservice: Refreshing state... ()
...
google_logging_project_sink.gateway_access_log_bigquery_sink: Refreshing state... ()
google_project_iam_member.gateway_access_log_bigquery_sink_writer_is_bigquery_data_editor: Refreshing state... ()
aws_s3_bucket.microservices_terraform_private_modules: Refreshing state... ()
aws_iam_role.datadog_aws_integration: Refreshing state... ()
aws_s3_bucket.terraform_backend: Refreshing state... ()
aws_iam_user.microservices_terraform: Refreshing state... ()
aws_iam_policy.datadog_aws_integration: Refreshing state... ()
aws_iam_user_policy.microservices_terraform: Refreshing state... ()
aws_iam_role_policy_attachment.datadog_aws_integration: Refreshing state... ()
google_dns_managed_zone.tfnotifyapps_com: Refreshing state... ()
google_dns_record_set.dev_tfnotifyapps_com: Refreshing state... ()
